...
public class _09_AvgAnArray_2ndSolution {
...
/*        Task: Generate an array of 10 integers randomly (between 0-100) and find the average.
                ...
                The average is:59.7
                The maximum value is: 94 and the it is at index 1
        ...
        //System.out.println("The index is: " + indexValueOfArray(array));
    ...
    public static void maxValueOfArray(int[] array){
        ...
        System.out.println("The maximum value is: " + max + " and the it is at : " + index );
    }
...
/*        int minIndex=Arrays.binarySearch(differenceArray,minNum);
        System.out.println("minIndex = " + minIndex);*/

        /*for (int i = 0; i < differenceArray.length-1; i++) {
            if (differenceArray[i]<=differenceArray[i+1]){
                minNum=differenceArray[i];
            } //else minNum = differenceArray[i+1];
        }*/

    /*    System.out.println("ilk minIndex = " + minIndex);
        if (minNum>differenceArray[differenceArray.length-1]){
             minNum=differenceArray[differenceArray.length-1];
             minIndex=differenceArray.length-1;
        }*/
